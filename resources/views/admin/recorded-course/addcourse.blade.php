...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Page/</span>Add Recorded Course</h4>
    <div class="col-xxl">
        <div class="card mb-4">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="mb-0">Add New Recorded Course</h5>
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{route('storercourse')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
