...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Page/</span>Add Live Course</h4>
    <div class="col-xxl">
        <div class="card mb-4">
            <div class="card-header d-flex align-items-center justify-content-between">
                <h5 class="mb-0">Add New Live Course</h5>
            ...
            <div class="card-body">
                ...
                @endif
                <form action="{{route('storelcourse')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="course_name">Course Name</label>
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="course_name" name="course_name" placeholder="Adobe Premier Pro" />
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="course_summary" id="course_summary" cols="30" rows="2"></textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" name="course_description" id="course_description" cols="30" rows="5"></textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="course_learnop">What will you learn</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" name="course_learnop" id="course_learnop" cols="30" rows="5"></textarea>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="course_requirment">Course Requirments</label>
                        <div class="col-sm-10">
                            <textarea class="form-control" name="course_requirment" id="course_requirment" cols="30" rows="5"></textarea>
                        </div>
                    </div>

                    <div class="row mb-3">
                        <label class="col-sm-2 col-form-label" for="course_duration">Course Duration (In Months)</label>
                        <div class="col-sm-10">
                            <input type="number" class="form-control" id="course_duration" name="course_duration" placeholder="3 Months" />
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" id="intro_link" name="intro_link" placeholder="url" />
                        </div>
                    </div>
