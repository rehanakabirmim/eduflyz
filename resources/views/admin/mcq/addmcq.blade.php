...
<div class="container-xxl flex-grow-1 container-p-y">
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        ...
        @endif
        <form action="{{ route('store.mcq') }}" method="POST">
          @csrf
                ...
                <tbody class="table-border-bottom-0">
                  @php $count = 1; @endphp
                    ...
                    <tr>
                        ...
                        <td>
                          <a href="{{route('editmcq',$question->question_id)}}" class="btn btn-primary mb-2">Edit</a> </br>
                          <a href="{{route('deletemcq', $question->question_id)}}" class="btn btn-warning">Delete</a>
                        </td>
