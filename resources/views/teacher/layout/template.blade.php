            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                ...
                <ul class="menu-inner py-1">
                    ...
                    <li class="menu-header small text-uppercase">
                        <span class="menu-header-text">My Courses</span>
                    </li>

                        <li class="menu-item">
                            <a href="{{route('teacher.recordcourse')}}" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-layout"></i>
                                <div>Recorded Course</div>
                            </a>
                        </li>

                        <li class="menu-item">
                            <a href="{{route('teacher.livecourse')}}" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-layout"></i>
                                <div>Live Course</div>
                            </a>
                        </li>
                    ...
                    <li class="menu-header small text-uppercase">
                        ...
                        <li class="menu-item">
                            <a href="{{route('tr.addlesson')}}" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-layout"></i>
                                <div>Add Lesson</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="{{route('tr.alllesson')}}" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-layout"></i>
                                <div>All Lesson</div>
                            </a>
                        </li>
                    ...
                    <!-- Assignment -->
                    <li class="menu-header small text-uppercase">
                        <span class="menu-header-text">Assignment</span>
                    </li>
                        <li class="menu-item">
                            <a href="{{route('tr.add.assignment')}}" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-layout"></i>
                                <div>Add Assignment</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="{{route('tr.all.assignment')}}" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-layout"></i>
                    ...
                    <li class="menu-header small text-uppercase">
                        ...
                        <li class="menu-item">
                            <a href="{{route('tr.addexam')}}" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-layout"></i>
                                <div>Add MCQ Exam</div>
                            </a>
                        </li>
                        <li class="menu-item">
                            <a href="{{route('tr.allexam')}}" class="menu-link">
                                <i class="menu-icon tf-icons bx bx-layout"></i>
