    ...
    <section class="pt-5 pb-9 py-md-7">
        <div class="container">
            <div class="text-center mb-5 mb-md-8">
                <h1 class="mb-1">Enrolled Courses</h1>
            ...
            <div class="row row-cols-md-2 row-cols-xl-3 mb-2">
                ...
                <p class="alert alert-danger">Sorry! You didn't enroll any course yet. </br>
                    Please enroll first!
                </p>
                @else
                ...
                @php
                $rcourse = App\Models\Course::where('id', $course->course_id)->first();
