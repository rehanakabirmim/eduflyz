...
class TeacherLessonController extends Controller
{
    public function AddLesson(){
        ...
        return view('teacher.lessons.addlesson', compact('courses'));
    }
    ...
    public function StoreLesson(Request $request){
        ...
        return redirect()->route('tr.alllesson')->with('message', 'Lesson Added Successfully!');
    }


    public function Alllesson(){
        $courses = Course::where('teacher_id', Auth::id())->get();
        return view('teacher.lessons.alllesson', compact('courses'));
    }

    public function EditLesson($id){
        $lesson = Lesson::findOrFail($id);
        $courses = Course::latest()->get();
        return view('teacher.lessons.editlesson', compact('lesson', 'courses'));
    }
    ...
    public function UpdateLesson(Request $request){
        ...
        return redirect()->route('tr.alllesson')->with('message', 'Lesson Updated Successfully!');
    ...
    public function EditLessonImg($id){
        ...
        return view('teacher.lessons.editlessonimg', compact('lesson'));
    }
    ...
    public function UpdateLessonImg(Request $request){
        ...
        return redirect()->route('tr.alllesson')->with('message', 'Lesson Image Updated Successfully!');
    ...
    public function Dellesson($id){
        ...
        return redirect()->route('tr.alllesson')->with('message', 'Lesson Deleted Successfully!');
    }
}
